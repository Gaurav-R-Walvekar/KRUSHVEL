              ...
              {[
                {
                  ...
                  h2: 'Send Inquiry',
                  label: 'Email Us',
                  value: 'info@krushvel.com',
                  href: 'mailto:info@krushvel.com',
                ...
                },
                {
                  ...
                  desc: 'Technical product specifications & support'
                },
                {
                  icon: '🤝',
              ...
              <ScrollReveal variant="fadeRight">
                <div className="glass-card-light p-8 rounded-2xl">
                  {submitted ? (
                    ...
                    <>
                      <h2 className="text-2xl font-bold text-slate-800 mb-6">Send Inquiry / Request Quote</h2>
