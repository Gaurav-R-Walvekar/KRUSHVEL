...
const services = [
  {
    ...
    desc: 'We source industrial parts from 100+ manufacturers across India to find the best quality at competitive prices for your specific requirements.',
...
export default function Services() {
  return (
    <>
      <SEOMeta
        title="Import Export Services India"
        metaTitle="Import Export Services India"
        description="Complete export services including sourcing, quality control, packaging and global logistics."
        keywords="import export services India, global sourcing services, LCL FCL shipments exporter, export documentation India"
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <ScrollReveal>
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Our Export Services</h1>
              <p className="text-xl text-slate-300 mb-8">
                Complete export services from product sourcing to door delivery. We handle everything so you can focus on your business.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link to="/contact" className="btn-primary">Request Export Support</Link>
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 max-w-2xl mx-auto">End-to-end export services for industrial parts from India to global buyers.</p>
            </div>
          </ScrollReveal>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              <h2 className="text-2xl font-bold text-slate-800 mb-6">Import Export Services from India</h2>
              <p className="text-slate-600 mb-4">
                Krushvel provides comprehensive <strong>import export services from India</strong> specializing in industrial crusher and conveyor parts. Our global sourcing services cover over 1000 industrial products from trusted Indian manufacturers.
              </p>
              <p className="text-slate-600 mb-4">
              ...
              <p className="text-slate-600">
                Our complete service package includes export documentation preparation, pre-shipment quality inspection, professional packaging, and end-to-end logistics coordination. Contact our team to discuss your import requirements.
              </p>
            </ScrollReveal>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-teal-600 to-cyan-600">
        <div className="container mx-auto px-4 text-center">
          <ScrollReveal>
            ...
            <p className="text-teal-100 mb-8 max-w-xl mx-auto">Contact our export team today and we'll guide you through the entire import process.</p>
