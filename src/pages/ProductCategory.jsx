...
const categoryMeta = {
  'crusher-spare-parts': {
    ...
    heroImage: '/images/JAW PLATES 2.jpeg',
    products: [
      { name: 'Jaw Plates', desc: 'High manganese steel jaw plates for primary crushing. Various sizes for different crusher models.', image: '/images/JAW PLATES 2.jpeg' },
      { name: 'Cheek Plates', desc: 'Side plates protecting crusher frame sides from wear during crushing operations.', image: '/images/JAW PLATES 2.jpeg' },
      { name: 'Toggle Plates', desc: 'Safety toggle plates protecting crusher from uncrushable material damage.', image: '/images/Toggal Plates.jpeg' },
      { name: 'Crusher Bolts', desc: 'High tensile fasteners for all types of crusher components.', image: '/images/Crusher boults.jpeg' },
      { name: 'Crusher Bearings', desc: 'Heavy-duty spherical roller bearings for all crusher types.', image: '/images/Crusher , Vibrator Bearings.jpeg' },
      { name: 'Crusher Gearbox', desc: 'Industrial gearboxes for crushers with high torque transmission.', image: '/images/Industrial Gearbox.jpeg' },
      { name: 'Heavy Springs', desc: 'Cone crusher and vibrating screen heavy duty springs.', image: '/images/HEAVY SPRINGS 1.jpeg' },
      { name: 'Cone Crusher Parts', desc: 'Mantle, concave, bowl liner and other cone crusher wear parts.', image: '/images/HEAVY SPRINGS 2.jpeg' },
      { name: 'VSI/Impact Crusher Parts', desc: 'Wear parts for VSI and horizontal shaft impact crushers.', image: '/images/Crusher boults.jpeg' },
    ],
  },
  'conveyor-components': {
    ...
    heroImage: '/images/CONVEYOR IDLER ROLLERS & FRAME.jpeg',
    products: [
      { name: 'Conveyor Idler Rollers', desc: 'Complete idler roller sets with frame for mining, quarry and cement plants.', image: '/images/CONVEYOR IDLER ROLLERS & FRAME.jpeg', bestseller: true },
      { name: 'Conveyor Impact Rollers', desc: 'Rubber ring cushioned impact rollers for belt loading points.', image: '/images/Impact Rollers 1.jpeg', bestseller: true },
      { name: 'Conveyor Drum Rollers', desc: 'Drive and tail end drum rollers for conveyor systems.', image: '/images/DRUM ROLLER.jpeg' },
      { name: 'Conveyor Belts', desc: 'EP fabric rubber conveyor belts for bulk material handling.', image: '/images/CONVEYOR BELT.jpeg' },
      { name: 'Conveyor Side Rollers', desc: 'Guide and side rollers for belt alignment and tracking.', image: '/images/GUIDE ROLLERS.jpeg' },
      { name: 'Rubber U-Bidding', desc: 'Skirting rubber for conveyor loading zones to prevent spillage.', image: '/images/Rubber U - Bidding.jpeg' },
    ],
  },
  'vibrating-screen': {
    ...
    heroImage: '/images/Vibrating Screen.png',
    products: [
      { name: 'Vibrating Screen Machine', desc: 'Linear and circular motion vibrating screens for material classification.', image: '/images/Vibrating Screen.png' },
      { name: 'Screen Bearing Housing', desc: 'Heavy-duty bearing housings for vibrating screens.', image: '/images/Crusher , Vibrator Bearings.jpeg' },
      { name: 'Wiremesh Screens', desc: 'Woven wire mesh screens in mild steel, SS and manganese steel.', image: '/images/Wiremesh Screens.png', bestseller: true },
      { name: 'Crusher Heavy Wiremesh', desc: 'Heavy gauge crimped wiremesh for primary screening applications.', image: '/images/Wiremesh Screens.png' },
      { name: 'Vibro Motor', desc: 'Industrial vibration motors with adjustable eccentric weights.', image: '/images/Vibro Motor.jpeg' },
      { name: 'Vibrating Screen Shaft', desc: 'Eccentric shafts for vibrating screens with precision machining.', image: '/images/Vibrating Screen Shaft (Excentric shaft).jpeg' },
    ],
  },
  'industrial-components': {
    ...
    heroImage: '/images/Perforated sheets.jpeg',
    products: [
      { name: 'Perforated Sheets', desc: 'Metal perforated sheets in MS, SS and aluminum for screening and filtration.', image: '/images/Perforated sheets.jpeg' },
      { name: 'Industrial Motors', desc: 'IE2/IE3 energy-efficient motors for industrial machinery.', image: '/images/INDUSTRIAL MOTOR.jpeg' },
      { name: 'Foundation Bolts', desc: 'Heavy-duty anchor and foundation bolts for machinery installation.', image: '/images/CRUSHER PEDISTIAL BOULTS 1.jpeg' },
      { name: 'Toggle Bearings', desc: 'Jaw crusher toggle bearings for smooth toggle plate movement.', image: '/images/TOGGAL BEARINGS.jpeg' },
      { name: 'Pillow Block Bearing', desc: 'UCF/UCP series pillow block bearings for industrial shaft mounting.', image: '/images/PELLOW BLOCK.jpeg' },
      { name: 'Pedestal Bearing', desc: 'Heavy-duty plummer block bearings for demanding applications.', image: '/images/Pedistal Bearing.jpeg' },
      { name: 'C-Clamp for Vibrator', desc: 'Anti-vibration clamping bolts for screen mesh panels.', image: '/images/vibrator clamping boults.jpeg' },
    ],
  },
}
