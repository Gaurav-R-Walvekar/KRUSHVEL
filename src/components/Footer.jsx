        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/company/krushvel" target="_blank" rel="noopener noreferrer"
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@krushvel.com" className="text-sm text-slate-300 hover:text-cyan-400 transition-colors">info@krushvel.com</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-cyan-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <a href="tel:+919999999999" className="text-sm text-slate-300 hover:text-cyan-400 transition-colors">+91 99999 99999</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-cyan-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">India (Exporting Globally)</p>
                </div>
              </li>
            </ul>
          </div>
