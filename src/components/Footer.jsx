    ...
    <footer className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Products */}
          <div>
            <h3 className="text-white font-semibold mb-5 text-sm uppercase tracking-wider">Our Products</h3>
            <ul className="space-y-2.5">
              {[
                ['Crusher Spare Parts', '/products/crusher-spare-parts'],
                ['Conveyor System Components', '/products/conveyor-components'],
                ['Vibrating Screen Equipment', '/products/vibrating-screen'],
                ['Industrial Components', '/products/industrial-components'],
                ['All Products', '/products'],
              ].map(([label, to]) => (
                <li key={to}>
                  <Link to={to} className="text-slate-400 hover:text-cyan-400 text-sm transition-colors flex items-center gap-1.5">
            ...
            <ul className="space-y-2.5">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=KrushvelGlobalExim@gmail.com" className="text-sm text-slate-300 hover:text-cyan-400 transition-colors">KrushvelGlobalExim@gmail.com</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-cyan-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <a href="tel:+919156087365" className="text-sm text-slate-300 hover:text-cyan-400 transition-colors">+91 91560 87365</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-cyan-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <a href="https://www.google.com/maps?q=18.48444,73.85656" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-300 hover:text-cyan-400 transition-colors">Pune, India</a>
                </div>
              </li>
            </ul>
            <div className="flex gap-3 mt-4">
              <a href="https://www.linkedin.com/in/akshay-gulunjkar-41b556220" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cyan-600 transition-colors"
                aria-label="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/krushvelglobalexim/" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://wa.me/919156087365" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.facebook.com/share/18UMHaae2E/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.youtube.com/@KrushvelGlobalExim" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-red-600 transition-colors"
                aria-label="YouTube">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
